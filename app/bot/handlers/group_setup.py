...
from app.services.message_builder import build_day_message, build_range_message, split_telegram, ParseMode
...
async def _send_range_schedule(message: Message, date_from: date, date_to: date, tz: str, ical_url: str | None) -> None:
...
async def group_week(message: Message) -> None:
    ...
    await _send_range_schedule(message, date_from, date_to, tz, ical_url)
